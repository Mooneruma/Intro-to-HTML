...
//          CHANGE THE FOLLOWING INFORMATION TO SEND EMAIL FOR YOU //  
	...
	$toEmail = "zvzz@hotmail.com";		//CHANGE within the quotes. Place email where you wish to send the form data. Use your instructor's email.
 	$subject = "WDV101 Email Example";	//CHANGE within the quotes. Place your own message.  For the assignment use "WDV101 Email Example" 
	$fromEmail = "moonsurv@kmoonpage.com";	//CHANGE within the quotes.  Use the address from host provider (Heartland-Webhosting) or DMACC address.
...
//   DO NOT CHANGE THE FOLLOWING LINES  //
	...
	$headers = "From: $from" . "\r\n";				//Creates the From header with the appropriate address
 	if (mail($to,$subject,$emailBody,$headers)) 	//puts pieces together and sends the email to your hosting account's smtp (email) server
	{
